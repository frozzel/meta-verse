  ...
  return (
    <>
      <a-scene look-controls="reverseMouseDrag: true" look-at="scene" animation-timeline__1="timeline: #myTimeline; loop: true">
        ...
        <Cloud x={40} y={3} z={-32.8}></Cloud>
        <Github x={-30} y={1} z={50}></Github>
        <Cortana x={-45} y={1} z={-32} ></Cortana>
        <Glow x={-45} y={4} z={-30} ></Glow>
        <ChatGpt x={-45} y={1} z={-27} ></ChatGpt>
        {/* <Glow x={-10} y={4} z={50} ></Glow> */}
